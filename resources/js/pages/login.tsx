        ...
        <div style={{ backgroundImage: `url(${telaLoginBg})` }} className="flex w-screen h-screen justify-center items-center bg-cover">
            <div className="flex h-125 w-150 flex-col gap-2 px-2 text-white bg-[#362312] rounded-lg border border-[#FFB562]">
                ...
                <form className="flex flex-col gap-2 m-3" action="" onSubmit={handleLogin}>
                    ...
                    <div className="flex col-2 gap-2 items-center justify-center w-full h-full">
                        <button onClick={handleLogin} className="w-20 h-10 font-sansita font-semibold bg-[#7C420B] hover:bg-[#402103] rounded-2xl border-2 border-black">
                            Entrar</button>

                        <button onClick={handleCadastro} className="w-25 h-10 font-sansita font-semibold bg-[#7C420B] hover:bg-[#402103] rounded-2xl border-2 border-black" type="submit">
                            Cadastre-se</button>
